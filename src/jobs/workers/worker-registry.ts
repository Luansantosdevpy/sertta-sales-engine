...
export const workerRegistrations: WorkerRegistration[] = [
  ...
  { queueName: QUEUE_NAMES.inboundEvents, processor: asGenericProcessor(baseProcessor) },
  ...
  { queueName: QUEUE_NAMES.aiTasks, processor: asGenericProcessor(baseProcessor) },
